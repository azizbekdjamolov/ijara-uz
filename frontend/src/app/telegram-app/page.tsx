    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-sm animate-fade-in-up">
          ...
          <h1 className="display text-xl font-bold text-foreground mb-2">Xatolik</h1>
          <p className="text-sm text-muted mb-6">{errorMsg}</p>
          <Link href="/" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#e8c869] to-[#d4af37] text-[#1a1405] text-sm font-semibold hover:brightness-110 transition-all">
            Saytga o'tish
          </Link>
        </div>
      </div>
